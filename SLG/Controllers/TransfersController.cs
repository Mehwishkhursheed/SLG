...
namespace SLG.Controllers.Inventory.Transfers
{
    public class TransfersController : Controller
    {
        ...
        public TransfersController(SLGC context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["backorder_doc_id"] = new SelectList(_context.Transfers, "ID", "Doc_name");
            ...
            var viewModel = new TransferViewModel
            {
                ...
                LineItems = new List<Transfer_Detail>(),
            };
        ...
        public async Task<IActionResult> Create(TransferViewModel viewModel)
        {
            ...
            {
                var lineItem = new Transfer_Detail
                {
